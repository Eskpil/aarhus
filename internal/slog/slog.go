...
func InitializeRlog() {
	zapConfig := createDefaultSLogConfig()
	if getIsDevelop() {
		zapConfig = createDevelopSLogConfig()
	}
...
// all configuration of slog should be done through config files or
// environment
func createDefaultSLogConfig() zap.Config {
...
func createDevelopSLogConfig() zap.Config {
	infoLevel := getLogLevelFromConfig()
